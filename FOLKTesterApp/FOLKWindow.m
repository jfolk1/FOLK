...
#import "FOLKWindow.h"
#import "FOLKUtility.h"
#import <objc/runtime.h>

@implementation FOLKWindow
...
- (void)makeKeyWindow {
    _previousKeyWindow = FOLKUtility.appKeyWindow;
    [super makeKeyWindow];
}
...
+ (void)initialize {
    ...
    // The FOLK window is intended to be an overlay that generally doesn't affect the app underneath.
